        				...
        				<div class="col-md-12 mb-5">
        					<ul class="nav nav-pills bg-white p-3" id="pills-tab" role="tablist">
        						<li class="nav-item" role="presentation">
        							<a class="nav-link active" id="pills-suhu-tab" data-toggle="pill" href="#pills-suhu"
        								role="tab" aria-controls="pills-suhu" aria-selected="true">Suhu</a>
        						</li>
        						<li class="nav-item" role="presentation">
        							<a class="nav-link" id="pills-kelembaban-tab" data-toggle="pill"
        								href="#pills-kelembaban" role="tab" aria-controls="pills-kelembaban"
        								aria-selected="false">Kelembaban</a>
        						</li>
        					</ul>
        					<div class="tab-content" id="pills-tabContent">
        						<div class="tab-pane fade show active" id="pills-suhu" role="tabpanel"
        							aria-labelledby="pills-suhu-tab">
        						...
        						<div class="tab-pane fade" id="pills-kelembaban" role="tabpanel"
        							aria-labelledby="pills-kelembaban-tab">
        							<div class="card card-primary card-outline">
        								<div class="card-header">
        									<h3 class="card-title">
        										<i class="far fa-chart-bar"></i>
        		...
        		<div class="modal-content">
        					...
        					<div class="form-group">
        						<p>
        							<h5 class="text-justify">
        								...
        								adalah website yang digunakan untuk memantau kondisi ruang penyimpanan rokok
        								cerutu berdasarkan parameter pengukuran variabel suhu dan kelembaban. Suhu dan
        								kelembaban diatur menggunakan kipas, lampu, dan modul pelembab secara otomatis.
        							</h5>
        						</p>
        					</div>
        				</div>
        			...
        			<div class="row">
        				<div class="col-md-12 ml-auto">
        					...
        					<form>
        						<div class="form-group">
        							<center><img src="<?= base_url("/assets/dist/img/alurAplikasi.JPG") ?>"
        									width="448px" height="546px" alt=""></center>
        						</div>
        					</form>
        				</div>
        			</div>
